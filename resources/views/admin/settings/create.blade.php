        ...
        <div class="w-full">
            ...
            <div class="py-6">
                <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    @if (session('success'))
                        <div
                            class="bg-green-100 border border-green-400 text-green-800 px-4 py-3 rounded relative dark:bg-green-700 dark:text-white dark:border-green-600 mb-6">
                    ...
                    <div
                        class="bg-white dark:bg-gray-800 shadow-lg sm:rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                        <form action="{{ route('admin.settings.store') }}" method="POST" class="space-y-5">
                            ...
                            <div>
                                ...
                                <input type="text" name="key" required value="{{ old('key') }}"
                            ...
                            <div>
                                <label class="block font-medium text-sm text-gray-700 dark:text-gray-300">Display
                                    Name</label>
                            ...
                            <div>
                                <label
                                    class="block font-medium text-sm text-gray-700 dark:text-gray-300">Details</label>
